...
if(isset($_POST['sub']))
{
    ...
    if($ins_stf>0)
    {
        ...
        {
            $ins_log=mysqli_query($dbcon,"INSERT INTO `user_log`(`id`, `uid`, `pwd`, `typ`, `st`) VALUES ('','$sid','$pas','office','1')");
...
{
	$did=$_GET['did'];
	$del=mysqli_query($dbcon,"delete from staf_data where stfid='$did'");
	if($del>0)
	{
                                                    ...
                                                    <div class="col-xs-12">
                                                        <div class="col-lg-6">
                                                            ...
                                                            <table class="table table-bordered table-condensed table-responsive table-striped">
                                                                <tr>
                                                                    <td colspan="2"><center><b>ADD OFFICE STAFF</b></center></td>
                                                                </tr>                                                                
                                                                ...
                                                                <tr>
                                                                    <td colspan="2"><center><input type="submit" name="sub" value="ADD Office Staff" class="btn btn-sm btn-danger" /></center></td>
                                                                </tr>
                                                            </table>
                                                            </form>
                                                        ...
                                                        <div class="col-lg-6">
                                                            <table class="table table-bordered table-condensed table-hover table-responsive table-striped">
                                                                ...
                                                                <?php
                                                                $sel_sa=mysqli_query($dbcon,"select * from staf_data where desig='4' and st='1'");
                                                                ...
                                                                <tr>
																	...
																	<td>
																		<a href="sadv.php?did=<?php echo $rsa[0] ?>"><span class="fa fa-trash"></span></a>
																	</td>
                                                                </tr>
                                                                <?php
                                                                    }
