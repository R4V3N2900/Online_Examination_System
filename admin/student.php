...
if(isset($_POST['sub']))
{
    ...
    $dep=$_POST['dep'];
    $ay=$_POST['ay'];
    header("location:student.php?c=$crs&d=$dep&a=$ay");
}
if(isset($_GET['regnil']))
{
    $crs=$_GET['c'];
    $dep=$_GET['d'];
    $ay=$_GET['a'];
    $up=mysqli_query($dbcon,"update student_data set regnum='nil' where admnum='".$_GET['regnil']."'");
    if($up>0)
    {
        header("location:student.php?c=$crs&d=$dep&a=$ay");
    }
                    ...
                    <td>
                        <div id="dep2">
                            <select name="dep" class="form-control">
                                                                ...
                                                                <tr>
                                                                    <td colspan="2"><select class="form-control" name="ay" required="required">
                                                                                    <option value="">Choose Academic year</option>
                                                                                    <?php
                                                                                    $sel_ay=mysqli_query($dbcon,"select distinct ay from student_data");
                                                                                    if(mysqli_num_rows($sel_ay)>0)
                                                                                    {
                                                                                        while($ray=mysqli_fetch_row($sel_ay))
                                                                                        {
                                                                                            ?>
                                                                                    <option><?php echo $ray[0] ?></option>
                                                                                    <?php
                                                                                        }
                                                                                    }
                                                                                    ?>
                                                                ...
                                                                <tr>
                                                                    <td colspan="2"><center><input type="submit" name="sub" value="SHOW LIST" class="btn btn-sm btn-danger" /></center></td>
                                                                </tr> 
                </tr>
                                                                    </td>
                                                                </tr>
						...
						<div class="row">                                                    
                                                        ...
                                                        if(isset($_GET['c']))
                                                        {
                                                            ...
                                                            $sel_st=mysqli_query($dbcon,"select * from student_data where crs='$c' and dep='$d' and ay='$a' order by st asc");
                                                         ...
                                                         <table class="table table-bordered table-condensed table-hover table-responsive">
                                                             ...
                                                             <tr>
                                                                 ...
                                                                 <td><?php echo $rst[13] ?></td>
                                                                 <td><?php echo $rst[12] ?><br /></td>
                                                             </tr>
                                                             <?php
                                                             }
                                                             ?>
