...
if(isset($_POST['ad_hod']))
{
    ...
    if($ins_stf>0)
    {
        if(move_uploaded_file($_FILES['up']['tmp_name'], getcwd()."\\../staffpic\\$nfn"))
        {
            $ins_log=mysqli_query($dbcon,"INSERT INTO `user_log`(`id`, `uid`, `pwd`, `typ`, `st`) VALUES ('','$sid','$pas','$typ','1')");
            header("location:department.php?crs=".$_GET['crs']."&dep=".$_GET['dep']."&z=1");
        }
    }
}
if(isset($_POST['ad_place']))
{
    $sn=$_POST['sn'];
    $sid=$_POST['sid'];
    $pas=$_POST['pas'];
...
{
	$did=$_GET['dep'];
	$dell=mysqli_query($dbcon,"delete from dep_info where depid='$did'");
	...
	<body class="no-skin">
		...
		<div class="main-container" id="main-container">
            ...
            <table class="table table-bordered table-condensed table-hover table-striped">
                ...
                <table class="table table-bordered table-condensed table-hover table-striped">
                    ...
                    <tr>
                        ...
                        <td><a href="department.php?edit=2&cid=<?php echo $rcrs[0] ?>&cn=<?php echo $rcrs[1] ?>"><span class="fa fa-plus-circle" title="Add Department"></span></a> | 
                            <a href="department.php?edit=1&cid=<?php echo $rcrs[0] ?>&cn=<?php echo $rcrs[1] ?>"><span class="fa fa-edit" style="color: green" title="Edit Course"></span></a></td>
                    </tr>
                    <?php
                        }
                    }
                ...
                <table class="table table-bordered table-condensed table-hover table-striped">
                    <tr>
                        <td colspan="2"><center><b>ADD STAFF - HEAD OF THE DEPARTMENT (HOD)</b></center></td>
                    </tr>
                    <tr>
                    <td>Staff Name</td>
                ...
                <tr>
                    <td colspan="2">
                <center>
                    <input type="submit" name="ad_hod" value="ADD STAFF" class="btn btn-sm btn-success" />
                </center>
                    </td>
                </tr>
            </table>  
                                  ...
                                  ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="department.php?crs=<?php echo $rd1[1] ?>&dep=<?php echo $rd1[0] ?>&del=1"><span class="fa fa-trash" title="Delete Now"></span></a>
