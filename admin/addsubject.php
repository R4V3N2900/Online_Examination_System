...
if(isset($_POST['sub']))
{
    ...
    $cid=$_POST['cr'];
    $sem=$_POST['sem'];
    header("location:addsubject.php?c=$cid&d=$did&s=$sem");
}
if(isset($_POST['sub1']))
{
    $crs=$_GET['c'];
    ...
    if(move_uploaded_file($_FILES['f']['tmp_name'], getcwd()."\\../syllabus\\$nfn"))
    {
        ...
        if($ins_syl>0)
        {
            header("location:addsubject.php?t=1&c=$crs&d=$dep&s=$sem");
        }
    }
}
if(isset($_GET['del']))
{
    ...
    $sem=$_GET['s'];
	$t=$_GET['t'];
	$del=mysqli_query($dbcon,"delete from syllabus_data where sylid='$subid'");
	if($del>0)
	{
		header("location:addsubject.php?t=$t&c=$crs&d=$dep&s=$sem");
	}
                                                    ...
                                                    <div class="col-xs-12">
                                                        <div class="col-lg-6">
                                                            ...
                                                            <form method="post" enctype="multipart/form-data">
                                                                ...
                                                                <tr>
                                                                    <td colspan="2">
                                                                        <a href="addsubject.php" class="label label-warning pull-right">BACK</a>
                                                        ...
                                                        <div class="col-lg-6">
                                                            ...
                                                            $i=0;
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><a target="_blank" href="../syllabus/<?php echo $rd[6] ?>"><span class="fa fa-download"></span></a>
																	<a href="addsubject.php?c=<?php echo $_GET['c'] ?>&d=<?php echo $_GET['d'] ?>&s=<?php echo $_GET['s'] ?>&subid=<?php echo $rd[0] ?>&del=1"><span class="fa fa-trash" title="Delete Now" style="color:red; float:right;"></span></a>
																	</td>        
                                                                </tr>
                                                                <?php
                                                                }
