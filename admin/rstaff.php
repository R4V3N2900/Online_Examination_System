...
if(isset($_POST['sub']))
{
    $c=$_POST['crs'];
    $d=$_POST['dep'];
    header("location:rstaff.php?d=$d&c=$c");
}
if(isset($_GET['delid']))
{
    $c=$_GET['c'];
    $d=$_GET['d'];
    $sid=$_GET['sid'];
    $del=mysqli_query($dbcon,"delete from subjct_assign where assignid='".$_GET['delid']."'");
    if($del>0)
    {
        header("location:rstaff.php?c=$c&d=$d&sid=$sid");
    } 
}
if(isset($_GET['re']))
{
    ...
    $ins1=mysqli_query($dbcon,"INSERT INTO `user_log`(`id`, `uid`, `pwd`, `typ`, `st`) VALUES ('','$sid','lbs','$typ','1')");
    if($ins1>0)
    {
        $up1=mysqli_query($dbcon,"update staf_data set st='1' where stfif='$sid'");
        if($up1>0)
        {
            header("location:rstaff.php?c=$c&d=$d");
        }
    }
}
?>
	...
	<body class="no-skin">
		...
		<div class="main-container" id="main-container">
                                                    ...
                                                    <div class="col-xs-12">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <table class="table table-bordered table-condensed table-hover table-responsive">
                                                                <tr>
                                                                    <td style="width: 50%">
                                                                        <select name="crs" id="crs" class="form-control" onchange="loaddep(this.value)" required="required">
            ...
            function loaddep(x)
            {
                ...
                <tr>
                    <td colspan="2"><center><input type="submit" name="sub" value="SHOW DETAILS" class="btn btn-sm btn-success" /></center></td>
                </tr>
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="col-lg-6">
                                                            ...
                                                            if(isset($_GET['c']))
                                                            {
                                                               ...
                                                               $rd1=mysqli_fetch_row($d1);
                                                                $sel_stf=mysqli_query($dbcon,"select * from staf_data where crs='$c' and dep='$d' and st=0");
                                                                if(mysqli_num_rows($sel_stf)>0)
                                                                {
                                                                    ?>
                                                                <table class="table table-bordered table-condensed table-responsive">
                                                                    <tr>
                                                                        <td colspan="6"><center><b><?php echo $rc1[1] ?> : <?php echo $rd1[2] ?></b></center></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>#</td>
                                                                        <td>Name</td>
                                                                    ...
                                                                    <?php
                                                                    $i=0;
                                                                    while($r_stf=mysqli_fetch_row($sel_stf))
                                                                    {
                                                                        $i++;
                                                                        ?>
                                                                    <tr>
                                                                        <td><?php echo $i ?></td>
                                                                        <td><?php echo $r_stf[1] ?> <span style="float: right;">(<?php echo $r_stf[2] ?>)</span></td>
                                                                        <td>
                                                                            <?php
                                                                            if($r_stf[5]=="1")
                                                                            {
                                                                        ...
                                                                        <td><?php echo $r_stf[7] ?></td>
                                                                        <td><a href="rstaff.php?d=<?php echo $d ?>&c=<?php echo $c ?>&sid=<?php echo $r_stf[2] ?>"><span class="glyphicon glyphicon-search" style="color:green; cursor: pointer;"></span></a></td>
                                                                    </tr>
                                                                    <?php
                                                                    }
                                                                    ?>
                                                        ...
                                                        <div class="col-lg-6">
                                                            ...
                                                            if(isset($_GET['sid']))
                                                            {
                                                                ...
                                                                $c=$_GET['c'];
                                                                $d=$_GET['d'];
                                                                $sel=mysqli_query($dbcon,"select * from staf_data where stfif='$sid'");
                                                                $r=mysqli_fetch_row($sel);
                                                                ?>
                                                                <table class="table table-bordered table-condensed table-responsive table-hover">
                                                                    <tr>
                                                                        <td style="width: 50%"><img src="../staffpic/<?php echo $r[10] ?>" class="img img-responsive" /></td>
                                                                        <td><b><span class="fa fa-user"></span> <?php echo $r[1] ?> (<?php echo $r[2] ?>)</b><br />
                                                                            <span class="fa fa-phone"></span>  <?php echo $r[7] ?><br />
                                                                            <span class="fa fa-envelope"></span>  <?php echo $r[8] ?><hr />
                                                                            DOB : <?php echo $r[11] ?><br />
                                                                            <br />
                                                                            <div class="alert alert-info">
                                                                            <center><b>MANAGE STAFF</b><br /><br />
                                                                        <?php
                                                                        if($r[12]=="1")
                                                                        {
                                                                        ?>
                                                                        ...
                                                                        <span id="cf1" class="label label-danger" style="cursor: pointer;" onclick="shocnfrm();">REMOVE STAFF</span>
                                                                        <div id="cf" style="display: none;">
                                                                            <a href="staff.php?c=<?php echo $c ?>&d=<?php echo $d ?>&sid=<?php echo $sid ?>&del=1" class="label label-danger">YES</a>
                                                                            <a href="staff.php?c=<?php echo $c ?>&d=<?php echo $d ?>&sid=<?php echo $sid ?>" class="label label-success">NO</a>
                                                                        </div>
                                                                        <?php
                                                                        }
                                                                        else
                                                                        ...
                                                                        <span id="bf1" class="label label-success" style="cursor: pointer;" onclick="shocnfrm();">ADD STAFF</span>
                                                                        <div id="bf" style="display: none;">
                                                                            <a href="rstaff.php?c=<?php echo $c ?>&d=<?php echo $d ?>&sid=<?php echo $sid ?>&des=<?php echo $r[5] ?>&re=1" class="label label-danger">YES</a>
                                                                            <a href="rstaff.php?c=<?php echo $c ?>&d=<?php echo $d ?>&sid=<?php echo $sid ?>" class="label label-success">NO</a>
                                                                        </div>
                                                                        <?php
                                                                        }
                                                                        ?>
