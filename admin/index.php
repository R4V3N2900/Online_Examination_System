						...
						<div class="row">
                                                    <div class="col-xs-12">
                                                        ...
                                                        <div class="col-sm-6">
                                                            ...
                                                            {
                                                            $selxam=mysqli_query($dbcon,"select * from xam_data where  xam_dt<='".date('Y-m-d')."'");
                                                            ...
                                                            <table class="table table-bordered table-condensed">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    if(mysqli_num_rows($chk1)>0)
                                                                    {
                                                                        ...
                                                                        <a href="index.php?eid=<?php echo $rxam[0] ?>"><span class="fa fa-file" title="View Result" style="color: green;"></span></a>
                                                                        <?php
                                                                    }
