...
{
    $stid=$_GET['stid'];
    $sel_st=mysqli_query($dbcon,"select * from student_data where admnum='$stid'");
...
if(isset($_GET['t']))
{
    if($_GET['t']=="1")
    {
        $up=mysqli_query($dbcon,"update student_data set st=2 where admnum='".$_GET['stid']."'");
        if($up>0)
        {
            header("location:studprofile.php?stid=".$_GET['stid']);
        }
    }
    if($_GET['t']=="3")
    {
        $up=mysqli_query($dbcon,"update student_data set active_st=3 where admnum='".$_GET['stid']."'");
        if($up>0)
        {
            header("location:studprofile.php?stid=".$_GET['stid']);
        }
                                                    ...
                                                    <div class="col-xs-12">
                                                        <div class="col-lg-5">
                                                            <table class="table table-bordered table-condensed">
                                                                <tr>
                                                                    <td style="width: 50%"><img src="../student/stud_pic/<?php echo $rst[16] ?>" class="img img-responsive img-thumbnail" /></td>
                                                                    <td style="width: 50%">
                                                                        <b><?php echo $rst[6] ?></b> (<?php echo $rst[7] ?>)<br />
                                                                        Reg.No <?php echo $rst[8] ?><br /><center>.........................................</center><br />
                                                                <span class="fa fa-envelope"></span> <span><?php echo $rst[9] ?></span><br />
                                                                <span class="fa fa-clock-o"></span> <span><?php echo $rst[11] ?></span><br />
                                                                <span class="fa fa-mobile"></span> <span><?php echo $rst[12] ?></span><br />
                                                                <span class="fa fa-ambulance"></span> <span><?php echo $rst[15] ?></span>
                                                                <br /><center>.........................................</center><br />
                                                                Father Name : <?php echo $rst[13] ?><br />
                                                                Contact Number : <?php echo $rst[14] ?><hr />
                                                                <?php
                                                                if($rst[17]==1)
                                                                {
                                                                ?>
                                                                <center>
                                                                    <a href="studprofile.php?stid=<?php echo $_GET['stid'] ?>&t=1" class="btn btn-sm btn-success">APPROVE</a>
                                                                <a href="studprofile.php?stid=<?php echo $_GET['stid'] ?>&t=2" class="btn btn-sm btn-warning">DENY</a>
                                                                </center>
                                                                <?php
                                                                }
                                                                ?>
                                                                <center>
                                                                    ...
                                                                    {
                                                                       ?>
                                                                    <span class="btn btn-danger btn-sm">ACCOUNT DELETED</span>
                                                                    <?php
                                                                    }
                                                                    else
                                                                    {
                                                                    ?>
                                                                    <a href="studprofile.php?stid=<?php echo $_GET['stid'] ?>&t=3" class="btn btn-sm btn-danger">DELETE ACCOUNT <span class="fa fa-trash"></span></a>
                                                                    <?php
                                                                    }
                                                                    ?>
                                                                </center>
                                                        ...
                                                        <div class="col-lg-7">
                                                            ...
                                                            <table class="table table-bordered table-condensed table-responsive table-hover">
                                                                <tr>
                                                                    <td colspan="4"><center><b>VIEW EDUCATION STATUS</b></center></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>#</td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>                                                                        
                                                                        <?php
                                                                        $chk1=mysqli_query($dbcon,"select * from sem_update_status where stud_id='".$_GET['stid']."' and sem='$i'");
                                                                        if(mysqli_num_rows($chk1)>0)
                                                                        {
                                                                            
                                                                                ?>
                                                                        <span class="label label-success pull-right" style="cursor: pointer;" onclick="shodata('<?php echo $i ?>')">Completed <span class="fa fa-arrow-down"></span></span> 
                                                                        <?php 
                                                                        }
                                                                        else
                                                                        {
                                                                             ?>
                                                                        <span class="label label-danger pull-right" style="cursor: pointer;" onclick="shodata('<?php echo $i ?>')">Not Completed <span class="fa fa-arrow-down"></span></span>
                                                                        <?php
                                                                        }
                                                                        ?>                                                                    
                                                                    </td>
                                                                <tr id="data<?php echo $i ?>" style="display: none;">
                                                                    <td colspan="4">
                                                                        ...
                                                                        <table class="table table-bordered table-condensed table-responsive table-hover">
                                                                            <tr>
                                                                                <td colspan="9"><center><b>MARK DETAILS OF SEMESTER <?php echo $i ?></b></center></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>#</td>
                                                                                <td>Subject Name</td>
                                                                            ...
                                                                            <?php
                                                                            $sel_subj=mysqli_query($dbcon,"select * from syllabus_data where crsid='$cid' and depid='$did' and sem='$i'");
                                                                            if(mysqli_num_rows($sel_subj)>0)
                                                                            {
                                                                                ...
                                                                                {
                                                                                    $chkmrk=mysqli_query($dbcon,"select * from sem_update_mark where stud_id='".$_GET['stid']."' and sub_code='$r_sub[5]'");
                                                                                    if(mysqli_num_rows($chkmrk)>0)
                                                                                    {
                                                                                        $rmrk=mysqli_fetch_row($chkmrk);
                                                                                        $im=$rmrk[3];
                                                                                        $em=$rmrk[4];
                                                                                        $tot=$im+$em;
                                                                                    }
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td><?php echo $r_sub[7] ?></td>
                                                                                <td><?php echo $im ?></td>
                                                                                <td><?php echo $em ?></td>
                                                                                <td><?php echo $tot ?></td>
                                                                                <td>
                                                                                    <div id="grd<?php echo $j ?>">
                                                                                    <?php
                                                                                    if($tot!=null)
                                                                                    {
                                                                                        $grd=($tot/150)*100;
                                                                            ...
                                                                            <tr>
                                                                                <td colspan="9">
                                                                                    ...
                                                                                    <?php
                                                                        echo "G.P.A : " .round($current_gpa,2);
                                                                        ?>
                                                                                    </div>
                                                                                    </td>
                                                                            </tr>
